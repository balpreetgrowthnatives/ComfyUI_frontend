...
| File                                                                                                              | Role                                                                    |
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------ |
| [`pages/cloud/supported-nodes.astro`](../src/pages/cloud/supported-nodes.astro) and [`[pack].astro`](../src/pages/cloud/supported-nodes/%5Bpack%5D.astro) | Page shells (and `zh-CN` twins)                                         |
| [`utils/cloudNodes.build.ts`](../src/utils/cloudNodes.build.ts)                                                       | `loadPacksForBuild()` shared by index + detail routes                   |
| [`utils/cloudNodes.ts`](../src/utils/cloudNodes.ts)                                                                   | Cloud `object_info` fetcher with retry, sanitization, snapshot fallback |
| [`utils/cloudNodes.registry.ts`](../src/utils/cloudNodes.registry.ts)                                                 | Registry enrichment (batches of 50, soft-fail)                          |
| [`utils/cloudNodes.ci.ts`](../src/utils/cloudNodes.ci.ts)                                                             | GitHub Actions annotations + step summary                               |
| [`utils/escapeJsonLd.ts`](../src/utils/escapeJsonLd.ts)                                                               | XSS-safe `<script type="application/ld+json">` serializer               |
| [`composables/useFilteredPacks.ts`](../src/composables/useFilteredPacks.ts)                                           | Search + sort logic for the index page                                  |
| [`composables/useNodesByCategory.ts`](../src/composables/useNodesByCategory.ts)                                       | Group nodes by category, alphabetized                                   |
